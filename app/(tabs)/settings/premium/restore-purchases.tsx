  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.placeholder}>
        <Ionicons name="refresh-outline" size={64} color={theme.colors.textLo} />
        <Text style={styles.placeholderText}>Coming Soon</Text>
        <Text style={styles.placeholderSubtext}>Restore purchases will be available once payment system is integrated</Text>
      </View>
    </View>
  );
}
