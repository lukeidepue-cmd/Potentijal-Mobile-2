  ...
  return (
    ...
    >
      ...
      <Pressable
        ...
        onPress={() => router.push("/(tabs)/(home)/tennis/weekly-goals")}
      >
...
const styles = StyleSheet.create({
  ...
  /* Graph-specific additions (match Basketball pattern) */
  search: {
  ...
  dropdownText: { color: theme.colors.textHi, fontSize: 12, letterSpacing: 0.2, fontFamily: "Geist_600SemiBold" },
  menu: {
    position: "absolute",
    top: 42,
    left: 0,
  ...
  menuText: { color: theme.colors.textHi, fontSize: 12, fontFamily: "Geist_600SemiBold" },
  chartWrap: {
    height: 220,
  ...
  /* Existing chip styles (kept intact) */
  ...
  chipText: { color: theme.colors.textHi, fontSize: 12, letterSpacing: 0.2, fontFamily: "Geist_600SemiBold" },
