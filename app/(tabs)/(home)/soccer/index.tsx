...
export default function SoccerHome() {
  ...
  const loadSchedule = async () => {
    ...
    if (data) {
      ...
      // Debug logging
      console.log('Soccer Schedule Load:', {
  ...
  useEffect(() => {
    if (exercise.trim() && user) {
      getPrimaryExerciseTypeDirect({ mode: 'soccer', query: exercise.trim() }).then(({ data: exerciseType, error }) => {
        if (error) {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerTopRow}>
          ...
          <Text style={styles.headerBrand}>Soccer</Text>
      ...
      >
            ...
            onPress={() => {
              ...
              if (gameCardRef.current) {
                gameCardRef.current.measure((x, y, width, height, pageX, pageY) => {
                  router.push({
                    pathname: "/(tabs)/(home)/soccer/add-game",
                    params: {
                      imageSource: "mbappe",
                ...
                router.push("/(tabs)/(home)/soccer/add-game");
              }
            }}
          onPressIn={() => {
        ...
        >
          <Animated.View style={[styles.logSectionInner, gameAnimatedStyle]}>
            <Image 
              source={require("../../../../assets/players/mbappe.webp")} 
            ...
            onPress={() => {
              ...
              if (practiceCardRef.current) {
                practiceCardRef.current.measure((x, y, width, height, pageX, pageY) => {
                  router.push({
                    pathname: "/(tabs)/(home)/soccer/add-practice",
                    params: {
                      imageSource: "yamal",
                      initialX: String(pageX),
                      initialY: String(pageY),
                ...
                router.push("/(tabs)/(home)/soccer/add-practice");
              }
            }}
          onPressIn={() => {
        ...
        >
          <Animated.View style={[styles.logSectionInner, practiceAnimatedStyle]}>
            <Image 
              source={require("../../../../assets/players/yamal.jpg")} 
              style={styles.logImage}
              resizeMode="cover"
            />
            {/* Gradient Scrim Overlay */}
